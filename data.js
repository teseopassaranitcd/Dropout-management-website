  ...
  11:{
    ...
    rooms:[
      ...
      },
      {
        ...
        hotspot:{x:47.8,y:67.0},
        overlayPoly:[[40.29,57.27],[55.31,57.27],[55.31,76.73],[40.29,76.73]]
      }
    ]
  },
  12:{
  ...
  15:{
    ...
    rooms:[
      ...
      },
      {
        ...
        overlayPoly:[[94.03,17.63],[83.57,17.42],[83.4,9.38],[8.81,9.56],[8.74,87.52],[84.6,86.04],[85.0,65.63],[94.27,65.43]]
      },
      {
        ...
        photos:[],
        floorIndex:2,
        hotspot:{x:41.02,y:28.8},
        overlayPoly:[[56.43,4.96],[25.61,4.98],[25.61,42.8],[56.43,42.95]]
      }
    ]
  },
  16:{
  ...
  17:{
    ...
    rooms:[
      ...
      },
      {
        ...
        photos:[],
        hotspot:{x:46.9,y:77.25},
        overlayPoly:[[58.05,67.41],[37.73,67.96],[35.29,87.43],[56.53,86.19]]
      }
    ]
  },
  18:{
...
window.SOLUZIONI_LIST = [
  ...
  {id:6,name:"Via Nuova n.115 - Piano I",zone:"Centro Storico",price:520,rooms:1,sqm:55,available:true, lat:42.404778,lng:12.865834,img:"images/via-nuova-115-piano-1/foto-01.jpg"},
  {id:7,name:"Via Nuova n.155 - Piano II",zone:"Centro Storico",price:750,rooms:1,sqm:70,available:true, lat:42.404778,lng:12.865834,img:"images/via-nuova-115-piano-2/foto-01.jpg"},
  {id:8,name:"Via Nuova n.115 - Piano III",zone:"Centro Storico",price:780,rooms:1,sqm:78,available:true, lat:42.404778,lng:12.865834,img:"images/via-nuova-115-piano-3/foto-01.jpg"},
  {id:9,name:"Via Porta Romana n.22",zone:"Porta Romana",price:600,rooms:1,sqm:50,available:true, lat:42.398305,lng:12.860369,img:"images/placeholder-apt.jpg"},
  {id:10,name:"Via P. Boschi n.29",zone:"Regina Pacis",price:280,rooms:4,sqm:130,roomDates:['2027-09-01','2026-08-01','2027-09-01','2027-01-01'], lat:42.407603,lng:12.853169,img:"images/via-boschi-29/foto-01.jpg"},
  {id:11,name:"Largo S. D\'Acquisto n.14",zone:"Micioccoli",price:260,rooms:3,sqm:90,roomDates:['2026-08-01','2026-12-01','2026-08-01'], lat:42.41629,lng:12.859835,img:"images/largo-dacquisto-14/foto-01.jpg"},
  {id:12,name:"Viale T. Morroni n.20",zone:"Viale Morroni",price:450,rooms:2,sqm:85,roomDates:['2026-08-01','2026-09-01'], lat:42.405201,lng:12.8646,img:"images/via-morroni-20/foto-01.jpg"},
  {id:13,name:"Via della Ripresa n.73",zone:"Centro Storico",price:250,rooms:4,sqm:90,roomDates:['2027-09-01','2027-06-01','2027-01-01','2027-09-01'], lat:42.404539,lng:12.865605,img:"images/via-ripresa-73/foto-01.jpg"},
  {id:14,name:"Via dei Tigli n.14",zone:"Viale Matteucci",price:300,rooms:3,sqm:110,roomDates:['2027-09-01','2027-09-01','2027-09-01'], lat:42.402504,lng:12.854594,img:"images/via-tigli-14/foto-01.jpg"},
  {id:15,name:"Via fratelli Cervi n.2",zone:"Molino della Salce",price:280,rooms:3,sqm:300,roomDates:['2026-08-01','2026-10-01','2026-08-01'], lat:42.404743,lng:12.848819,img:"images/via-fratelli-cervi-2/foto-01.jpg"},
  ...
  {id:17,name:"Via G. Garibaldi n.89 - Secondo",zone:"Centro Storico",price:275,rooms:3,sqm:300,roomDates:['2027-09-01','2026-12-01'], lat:42.404495,lng:12.868609,img:"images/via-garibaldi-89-secondo/foto-01.jpg"},
  {id:18,name:"Via G. Garibaldi n.89 - Secondo rialzato",zone:"Centro Storico",price:475,rooms:1,sqm:45,available:true, lat:42.404495,lng:12.868609,img:"images/via-garibaldi-89-secondo-rialzato/foto-01.jpg"},
  {id:19,name:"Via Contigliano n.12",zone:"Viale Maraini",price:300,rooms:3,sqm:120,roomDates:['2026-10-01','2027-03-01','2027-03-01'], lat:42.406339,lng:12.858418,img:"images/via-contigliano-12/camera2-01.jpg"}
];
