...
window.APARTMENTS = {
  ...
  9:{
    ...
    cover:'images/via-porta-romana-22/foto-02.jpg',
    sideImg:'images/via-porta-romana-22/foto-01.jpg',
    gallery:[
      'images/via-porta-romana-22/foto-02.jpg',
      'images/via-porta-romana-22/foto-03.jpg',
      'images/via-porta-romana-22/foto-04.jpg',
      'images/via-porta-romana-22/foto-05.jpg',
      'images/via-porta-romana-22/foto-06.jpg',
      'images/via-porta-romana-22/foto-07.jpg',
    ],
    descrizione:{it:"Grazioso appartamento al primo piano di una palazzina in Via Porta Romana n.22, a pochi passi da Piazza Cavour. In cinque minuti a piedi si raggiungono il centro storico e tutti i principali servizi, così come la suggestiva passeggiata del Lungovelino. In Piazza Cavour si trova la fermata degli autobus urbani, così come quella delle linee Cotral, principale collegamento con Roma. L'appartamento si compone di ingresso/living, cucina abitabile, bagno con vasca, camera matrimoniale e cameretta. La soluzione è ottima per una coppia intenzionata a condividere la camera matrimoniale e utilizzare la cameretta come studio, ma è possibile anche la configurazione con due camere da letto, una più grande e una più piccola. L'appartamento è arredato con gusto ed è fornito di tutte le comodità.",en:"Charming apartment on the first floor of a small building in Via Porta Romana n.22, just a few steps from Piazza Cavour. The historic centre and all the main services can be reached on foot in five minutes, as can the scenic Lungovelino promenade. Piazza Cavour is home to the urban bus stop as well as the Cotral coach stop, the main connection to Rome. The apartment comprises an entrance/living room, an eat-in kitchen, a bathroom with bathtub, a double bedroom and a smaller bedroom. It's an excellent solution for a couple willing to share the double bedroom and use the smaller room as a study, but it can also be arranged as two separate bedrooms, one larger and one smaller. The apartment is tastefully furnished and equipped with every comfort."},
    caratteristiche:[
    ...
    servizi:[
      {name:{it:'Fermata autobus',en:'Bus stop'},dist:{it:'nelle vicinanze',en:'nearby'}},
      {name:{it:'Banca',en:'Bank'},dist:{it:'nelle vicinanze',en:'nearby'}},
      {name:{it:'Sede Università La Sapienza',en:'La Sapienza University campus'},dist:{it:'nelle vicinanze',en:'nearby'}},
      {name:{it:'Bar',en:'Café'},dist:{it:'nelle vicinanze',en:'nearby'}},
      {name:{it:'Ristoranti',en:'Restaurants'},dist:{it:'nelle vicinanze',en:'nearby'}},
      {name:{it:'Supermercato',en:'Supermarket'},dist:{it:'nelle vicinanze',en:'nearby'}},
    ],
    rentalMode:'intero',
    interoPricing:[{persone:2,prezzo:600}],
    deposito:2,
    floorplan:'images/via-porta-romana-22/planimetria.png',
    rooms:[
...
window.SOLUZIONI_LIST = [
  ...
  {id:9,name:"Via Porta Romana n.22",zone:"Porta Romana",price:600,rooms:1,sqm:50,available:false, lat:42.398305,lng:12.860369,img:"images/via-porta-romana-22/foto-01.jpg"},
